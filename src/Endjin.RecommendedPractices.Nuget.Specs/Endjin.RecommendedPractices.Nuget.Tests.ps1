...
Describe 'Packaging tests' {
    ...
    & nuget.exe sources Add -Name "EndjinRecommendedPracticesLocal" -Source $packageOutputDir

    & nuget.exe pack $recommendPracticesNuspec -Version "0.0.1-local" -OutputDirectory $packageOutputDir -NoDefaultExcludes
    ...
    & nuget.exe sources Remove -Name "EndjinRecommendedPracticesLocal"
